            ...
            <div id="carouselExampleCaptions" class="carousel slide">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption-hack carousel-caption d-none d-md-block">
                            <h5><a href="fundament.php">Фундамент</a></h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="containers">
                    <div class="section-title white">
                        <div class="title-block">
                            <h3 class="title">Этапы работы</h3>
                        </div>
                    </div>
                    <div class="steps-list">
                        <div class="item">
                            <div class="title">Согласуем</div>
                            <div class="text">
                                Подберём проект дома, согласуем
                                детали и утвердим договор с Вами
                            </div>
                        </div>
                        <div class="item">
                            <div class="title">Доставим</div>
                            <div class="text">
                                Доставим и выгрузим древесину на Ваш
                                участок без предоплаты
                            </div>
                        </div>
                        <div class="item">
                            <div class="title">Подпишем</div>
                            <div class="text">
                                Подпишем с вами договор на месте,
                                получим оплату в размере 75%
                            </div>
                        </div>
                        <div class="item">
                            <div class="title">Построим</div>
                            <div class="text">
                                Проведём полный комплекс
                                строительных и отделочных работ
                            </div>
                        </div>
                        <div class="item">
                            <div class="title">Сдадим</div>
                            <div class="text">
                                Подпишем акт сдачи и приёмки
                                дома
                            </div>
                        </div>
                        <div class="item">
                            <div class="title">Рассчитаемся</div>
                            <div class="text">
                                Получим оплату оставшихся 25%
                                стоимости работ
                            </div>
                        </div>
                    </div>
