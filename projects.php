    ...
    <div class="container">
        ...
        <div class="catalog">
            <div class="row filter__top">
                <div class="col ">
                    <div class="filter__button" id="filter_btn">
                        Фильтр <img src="assets/sprite.svg#sliders-h-solid" height="20" class="ms-2" alt="Фильтр">
                    </div>
                </div>
                
            </div>
            <div class="filter-results   projects mb-4" id="pdopage">
                <div id="mse2_results" class="rows row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-3">
                    <div class="col ">
                        <div class="procard ">
                ...
                <div class="mse2_pagination">
                    <div class="pagination">
                        <span class="pagination-link active" "=" " href="projects/">1</span>
